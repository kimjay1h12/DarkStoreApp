...
export default function MiniDrawer({ children, active }) {
  ...
  return (
    <Box sx={{ display: "flex", boxShadow: 0 ,}}>
      ...
      <Drawer sx={{ boxShadow: 1,background:"#000" }} variant="permanent" open={open}>
        <DrawerHeader>
          <img
            src={"/img/logo.png"}
            style={{
          ...
          <IconButton
            style={{ display: "flex", justifyContent: "flex-end",color:"#f7f7f7" }}
          ...
          {routes.map((text, index) => (
            <ListItem key={text} disablePadding sx={{ display: "block", }}>
              <ListItemButton
                ...
                sx={{
                  backgroundColor: active === text.active && "#f7f7f7",
                  minHeight: 48,
              ...
              >
                <ListItemIcon
                  sx={{
                    minWidth: 0,
                    mr: open ? 3 : "auto",
                    color:  active === text?.active?"#000":"#fff",
                ...
                <ListItemText
                  primary={text.label}
                  sx={{ opacity: open ? 1 : 0 ,color: active === text?.active?"#000":"#fff",}}
                />
              </ListItemButton>
            </ListItem>
          ))}
