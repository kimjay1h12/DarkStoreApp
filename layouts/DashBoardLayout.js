        ...
        {routes.map((item, index) => (
          <ListItem
            ...
            sx={{
              color: "#000",
              marginBottom: 2,
              background: item.active === route ? "#fff" : "#000",
            }}
          >
                ...
                {open && (
                  ...
                  >
                    {management.map((item, i) => (
                      <ListItemButton
                        sx={{
                          background: item.active === mroute ? "#fff" : "",
                        }}
                        onClick={() => {
                          setAnchorEl(!anchorEl);
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Hidden smUp>
          <Box style={{ background: "#000", minHeight: "100vh" }} mt={9}>
            {children}
          </Box>
        </Hidden>
        <Hidden smDown>
          ...
          <Box style={{ background: "333", minHeight: "100vh" }}>
            {children}
          </Box>
        </Hidden>
      </Box>
